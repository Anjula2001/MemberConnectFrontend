...
export function NewMemberRegistrationForm({
  ...
  const onSubmit = async (data: MemberRegistration) => {
    ...
    try {
      ...
      const response = await createMemberApplication(payload);
      if (response.id) {
        setSavedApplicationId(response.id);
        const summary = await getDocumentSummary(response.id);
        setDocumentSummary(summary);
        alert("Registration saved successfully! You can now upload documents.");
  ...
  return (
    ...
    >
      <TabsList className="grid w-full grid-cols-2 bg-gray-100 p-1 rounded-lg">
        <TabsTrigger
          value="application"
          className="data-[state=active]:bg-[#953002] data-[state=active]:text-white"
        >
          Application Details
        </TabsTrigger>
        <TabsTrigger
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      ...
                      >
                        ...
                        <SelectContent>
                          <SelectItem value="Colombo South School">
                            Colombo South School
                          </SelectItem>
                          <SelectItem value="Colombo North School">
                            Colombo North School
                          </SelectItem>
                          <SelectItem value="Homagama School">
                            Homagama School
                          </SelectItem>
                        </SelectContent>
                      </Select>
